...
public class Course_InstrAdapter extends RecyclerView.Adapter<Course_InstrAdapter.Course_InstrHolder> {
    ...
    private List<TrackInstructor> instructors = Collections.emptyList();
    private LayoutInflater inflater;
    private Context context;

    public Course_InstrAdapter(Context context, List<TrackInstructor> instructors){
    ...
    public int getItemCount() {
        Log.i("arraaaaaaay", String.valueOf(instructors.size()));
